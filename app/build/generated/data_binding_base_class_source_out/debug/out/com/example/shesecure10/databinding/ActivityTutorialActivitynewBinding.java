...
public final class ActivityTutorialActivitynewBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityTutorialActivitynewBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityTutorialActivitynewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTutorialActivitynewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tutorial_activitynew, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTutorialActivitynewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTutorialActivitynewBinding((ConstraintLayout) rootView, articlesCard,
