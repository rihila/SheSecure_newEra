        ...
        getDirection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (place2 != null && currentLocation != null) {
                    ...
                    mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng((currentLocation.latitude+destinationLocation.latitude)/2 , (currentLocation.longitude+destinationLocation.longitude)/2), 15));
